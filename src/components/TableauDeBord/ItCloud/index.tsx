...
import Image from "next/image"; // Importation d'Image de next/image
          ...
          <div className="mt-4 overflow-x-auto rounded-lg border shadow-sm">
            <table className="w-full table-auto text-left text-sm">
              ...
              <tbody className="mb-3 divide-y text-gray-600">
                <tr>
                  <td className="flex items-center gap-x-3 whitespace-nowrap px-3 py-3">
                    <Image
                      src="/images/fav.PNG"
                      alt="Logo entreprise"
                      width={40} // Ajouter des dimensions appropriées
                      height={40}
                ...
                {/* Répétez la structure pour chaque ligne de la table en remplaçant <img> par <Image /> */}
              </tbody>
            </table>
          </div>
          {/* ... Reste du code */}
